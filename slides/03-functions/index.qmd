...
- You can get the files by creating a new project from version control in RStudio (if set up, as per the [previous session](../02-github/index.qmd))
...
# Documenting and testing {.inverse}
